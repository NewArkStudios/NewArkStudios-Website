    ...
    var app = {
        ...
        'animations' : function() {
        	...
        	$(window).scroll(function() {
        		 if ($(this).scrollTop() + 500 > $("#main-description").position().top && !self.triggerAnimations['main-description']) {
        		 ...
        		 // mechanics section
        		 if ($(this).scrollTop() + 500 > $("#mechanics-title").position().top && !self.triggerAnimations['mechanics']){
        		 ...
        		 if ($(this).scrollTop() + 500 > $("#gallery-section").position().top && !self.triggerAnimations['gallery']){
        		 ...
        		 if ($(this).scrollTop() + 500 > $("#bottom-banner").position().top && !self.triggerAnimations['bottom']){
